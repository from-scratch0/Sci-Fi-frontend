...
var scene, renderer, camera, light, ambientLight;
var stars = [];
var nbPlanetsMax = 4;
var planets = [];
...
function animateStars(z) {
    ...
    for (var i = 0; i < stars.length; i++) {
        ...
        if (stars[i].position.z > z) stars[i].position.z -= 2000;
...
var Planet = function(z) {
    ...
    geomPlanet.vertices = [{x: 1, y:1, z:1}, {x: -1, y:-1, z:1}, {x: -1, y:1, z:-1}, {x: 1, y:-1, z:-1}]
